-- Script para poblar reservas para junio a diciembre 2025
...
BEGIN
    ...
    -- Iterar sobre cada clase de junio a diciembre 2025
    FOR class_record IN 
    ...
    RAISE NOTICE 'Poblado completado: reservas_clase para junio a diciembre 2025';
END $$;

-- Consulta para verificar la cantidad de reservas creadas para junio-diciembre 2025
SELECT
...
WHERE c.fecha >= '2025-06-01'::timestamp with time zone
  AND c.fecha < '2026-01-01'::timestamp with time zone
GROUP BY DATE_TRUNC('month', c.fecha)
ORDER BY mes ASC;

-- Resumen general de todas las reservas 2024-2025
SELECT
