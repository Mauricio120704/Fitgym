-- Script para poblar la tabla reservas_clase con datos coherentes del 2024 al 2025
-- Utiliza datos de las tablas clases y personas para garantizar coherencia
...
BEGIN
    -- Limpiar reservas existentes (opcional, comentar si no se desea)
    -- DELETE FROM public.reservas_clase;
    
    -- Iterar sobre cada clase que existe en la tabla 'clases'
    FOR class_record IN 
    ...
    RAISE NOTICE 'Poblado completado: reservas_clase';
END $$;
